...
void UIDemo18::initForm()
{
    ...
    IconHelper::Instance()->setIcon(ui->btnReturn, (QChar)0xf073, navIcoWidth);
    IconHelper::Instance()->setIcon(ui->btnMsg, (QChar)0xf27a, navIcoWidth);
...
void UIDemo18::initNav()
{
    ...
    listChar << (QChar)0xf030 << (QChar)0xf108 << (QChar)0xf002 << (QChar)0xf03e << (QChar)0xf0e8 << (QChar)0xf085;
...
void UIDemo18::buttonClicked()
{
    ...
    IconHelper::Instance()->setIcon(ui->btnReturn, (QChar)0xf122, navIcoWidth);
}
