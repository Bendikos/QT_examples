    ...
    :QToolBox(parent,f)
{
    ...
    layout1->setContentsMargins(10, 10, 10, 10);  // 设置所有四个方向的边距为 10 像素                             //布局中各窗体的显示间距
    ...
    layout2->setContentsMargins(10, 10, 10, 10);  // 设置所有四个方向的边距为 10 像素
    ...
    layout3->setContentsMargins(10, 10, 10, 10);  // 设置所有四个方向的边距为 10 像素
